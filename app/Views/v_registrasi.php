                                    ...
                                    <div class="mb-0 p-0 p-lg-3">
                                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                                            ...
                                            <div class="auth-title-section mb-4 text-lg-start text-center">
                                                <h3 class="text-dark fw-semibold mb-3">Selamat datang kembali! Silakan Daftar untuk melanjutkan..</h3>
                                                <p class="text-muted fs-14 mb-0">Daftar untuk dapat mengakses dashboard Operator anda.</p>
                                            </div>

                                            <div class="saprator my-4"><span>Daftar Akun Operator</span></div>

                                            <div class="pt-0">
                                                <form method="POST" action="buatproses" class="my-4">
                                                    <?= csrf_field() ?>
                                                    <div class="form-group mb-3">
                                                        <label for="nama operator" class="form-label">Nama Operator</label>
                                                        <input name="nama" class="form-control" type="text" id="nama operator" required="" placeholder="Masukan Nama Anda">
                                                    </div>
                                                    <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-group mb-0 row">
                                                        <div class="col-12">
                                                            <div class="d-grid">
                                                                <button class="btn btn-primary fw-semibold" type="submit" id="submitBtn"> Log In </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                                ...
                                                <div class="text-center text-muted">
                                                    <p class="mb-0">Sudah Punya Akun ?<a class='text-primary ms-2 fw-medium' href='masuk_admin'>Masuk ke Sini</a></p>
                                                </div>
