                    ...
                    <div class="align-items-center">
                        ...
                        <div class="hando-main-sections">
                            ...
                            <div class="overflow-hidden ms-md-4 ms-0">
                                <h4 class="m-0 text-dark fs-20 mt-2 mt-md-0"><?= session()->get('nama') ?></h4>
                                <p class="my-1 text-muted fs-16"><span>Role : </span><?= session()->get('level') ?></p>
                                <div class="mb-2"><span>Email : </span><?= session()->get('username') ?></div>
    ...
    <div class=" modal fade" id="bs-example-modal-center<?= session()->get('admin_id') ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="row g-3" method="POST" action="ubah_operator/<?= session()->get('admin_id') ?>">
                    <div class="modal-body">
                        <div class="col-12 mt-3">
                            <label for="validationDefault01" class="form-label">Nama Operator</label>
                            <input type="text" name="nama_operator" class="form-control" value="<?= session()->get('nama') ?>" placeholder="Masukan Nama Operator" id="validationDefault01" required>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="validationDefault01" class="form-label">Pasword Baru</label>
                            <input type="text" name="nama_operator" class="form-control" placeholder="Masukan Pasword Baru" id="password" required>
                        </div>
                        <div class="col-12 mt-3">
                            <label for="validationDefault01" class="form-label">Konfirmasi Pasword</label>
                            <input type="text" name="nama_operator" class="form-control" placeholder="Konfirmasi Password" id="confirm_password" required>
                        </div>
                    </div>
