...
var options = {
    ...
    chart: { height: 300, type: "pie", parentHeightOffset: 0 },
...
options = {
  ...
  chart: { height: 300, type: "donut", parentHeightOffset: 0 },
  legend: { position: "bottom" },
...
options = {
  series: [44, 55, 41, 17, 15],
  chart: { height: 330, type: "donut", parentHeightOffset: 0 },
...
options = {
  ...
  grid: { borderColor: "#f1f1f1", padding: { bottom: -80 } },
...
options = {
  ...
  title: { text: "Favourite Movie Type" },
